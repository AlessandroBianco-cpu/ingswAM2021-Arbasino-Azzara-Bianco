...
public class BeforeMainActionState extends PlayerState{
    ...
    /**
     * This method manages the will of the player of performing a market insertion action.
     * @param message insert marble request from the player.
     */
    ...
    /**
     * This method manages the will of the player of a buy Development Card action.
     * @param message buy devCard request from the player.
     */
    ...
    /**
     * This method manages the will of the player of a buy Development Card action.
     * @param message activate production request from the player.
     */
