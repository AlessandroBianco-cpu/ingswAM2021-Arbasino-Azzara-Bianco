...
public class StringToPrint {
    ...
    public final static String setInitialResourcesMessage = "setInitialResources";
    ...
    //TODO: queste sono da aggiungere al player state al posto delle stringhe fatte in quel modo
